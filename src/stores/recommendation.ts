...
export const useRecommendationStore = defineStore("recommendation", ()=>{
  ...
  updatePref()
  let cards = $ref<Card[]>([])
  getSixCards().then(data => cards = data)
  ...
  async function getSixCards(): Promise<Card[]>{
    ...
    const response = await axios.put("https://recommendsittofit.herokuapp.com/cards", {
      web_id: browserId
    })
  ...
  async function getOneCard(): Promise<Card>{
    // put id to server to get cards
    const response = await axios.put("https://recommendsittofit.herokuapp.com/crosscard", {
      web_id: browserId
    })
  ...
  async function updatePref(){
    // put id to server
    await axios.put("https://recommendsittofit.herokuapp.com/preference", {
      web_id: browserId,
